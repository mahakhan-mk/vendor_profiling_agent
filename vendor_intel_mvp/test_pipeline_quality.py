...
TRUST_PAGE_TERMS = [
    "trust", "security", "msrc", "security-center", "compliance", "privacy", "status"
]
...
def deterministic_trust_signal(evidence: List[Dict[str, Any]]) -> Dict[str, Any]:
    for item in evidence:
        ...
        if any(term in haystack for term in TRUST_PAGE_TERMS):
            return {
                "found": True,
                "details": "Approved-source security, trust, compliance, status, or advisory page was found deterministically.",
                "source_url": url,
            }
    return {
        "found": False,
        "details": "No approved-source trust, security, compliance, status, or advisory page was detected in retrieved evidence.",
        "source_url": None,
    }
...
def collect_evidence(vendor: str, candidates: List[Dict[str, Any]]) -> Dict[str, Any]:
    ...
    return {
        "vendor": vendor,
        "evidence": capped,
        "deterministic_trust_signal": deterministic_trust_signal(capped),
